...
def build_moderada():
  ...
  <div class="prose">
    ...
    <div class="media-split media-split--img-right">
      ...
      <figure class="img-card media-split__media media-split__media--prod">
        <img src="/assets/trat-iontoforesis.jpg" alt="Equipo de iontoforesis para hiperhidrosis palmar y plantar" width="1500" height="1500" loading="lazy">
      </figure>
    </div>
    ...
    <div class="media-split media-split--img-right">
      ...
      <figure class="img-card media-split__media media-split__media--prod">
        <img src="/assets/trat-botox.jpg" alt="Toxina botulínica (Botox) para hiperhidrosis" width="700" height="525" loading="lazy">
      </figure>
    </div>
  ...
  <div class="quiz">
    ...
    <div id="quiz-result" class="quiz-result" role="status">
      ...
      <div class="qr-actions">
        <a id="quiz-result-primary" href="#" class="btn-pill cta-btn"></a>
        <a id="quiz-result-secondary" href="#" class="btn-pill cta-btn" style="background:rgba(255,255,255,.14)" hidden></a>
